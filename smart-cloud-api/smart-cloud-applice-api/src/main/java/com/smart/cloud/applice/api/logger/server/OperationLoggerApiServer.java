 ...
 * @module: SmartCloud项目-OperationLoggerApiServer类，主要位于OperationLogger-应用操作日志ApiServer模块的业务场景
 * @content: OperationLoggerApiServer类，主要用于完成应用操作日志API服务端的封装和定义.
 * @author: Powered by Marklin
 * @datetime: 2023-06-22 05:12
 * @version: 1.0.0
